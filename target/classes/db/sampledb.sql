CREATE TABLE MEMBER(USERID VARCHAR(20) NOT NULL PRIMARY KEY,PASS VARCHAR(100),NAME VARCHAR(20),GENDER VARCHAR(1),BIRTH VARCHAR(20),TEL VARCHAR(20),ZIPCODE VARCHAR(20),ADDRESS VARCHAR(200));
--INSERT INTO MEMBER (USERID, PASS, NAME, GENDER, BIRTH, TEL, ADDRESS) VALUES ('홍길동', '1234', 'df', 'M', '2000-01-01', '010-1111-2222', '0000df', 'df');
